...
function listenHeaderStuck() {
  const stuckRef = stringToHTML('<div class="stuck-ref" aria-hidden="true"></div>');
...
export default async function decorate(block) {
  ...
  if (resp.ok) {
    ...
    nav.querySelector('.nav-brand a').ariaLabel = 'Link to homepage';
